...
enemyImage.src = 'path/to/inimigos.png';
...
let blocks = [
    ...
    { x: 7, y: 4, type: 'destructible', points: 30 },
    { x: 8, y: 4, type: 'indestructible' },
    { x: 5, y: 7, type: 'indestructible' },
    { x: 4, y: 7, type: 'destructible', points: 40 },
    // outros blocos
];
let enemies = [
    { x: 5, y: 5 },
...
function explodeBomb(x, y) {
    ...
    setTimeout(() => {
        ...
        if (enemies.length === 0) {
            ...
            window.location.href = 'fase2.html';  // Mude para o nome do arquivo da segunda fase
        } else {
