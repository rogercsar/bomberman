...
blockImage.src = 'path/to/fase3/blocos3.png';
destructibleBlockImage.src = 'path/to/fase3/blocosdes.png';
enemyImage.src = 'path/to/fase3/inimigos3.png';
...
let blocks = [
    ...
    { x: 1, y: 1, type: 'destructible', points: 10 },
...
function explodeBomb(x, y) {
    ...
    setTimeout(() => {
        ...
        if (enemies.length === 0) {
            ...
            window.location.href = 'fase4.html';  // Mude para o nome do arquivo da segunda fase
        } else {
