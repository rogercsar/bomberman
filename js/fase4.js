...
blockImage.src = 'path/to/fase4/blocos.png';
destructibleBlockImage.src = 'path/to/fase4/blocos3.png';
enemyImage.src = 'path/to/fase4/inimigos4.png';
bombImage.src = 'path/to/bomba.webp';
explosionImage.src = 'path/to/explosao.webp';

let playerPosition = { x: 0, y: 0 };
let blocks = [
    { x: 0, y: 2, type: 'indestructible' },
    { x: 4, y: 1, type: 'destructible', points: 10 },
    { x: 2, y: 2, type: 'destructible', points: 20 },
    { x: 4, y: 3, type: 'indestructible' },
    { x: 5, y: 4, type: 'destructible', points: 30 },
    { x: 7, y: 5, type: 'indestructible' },
    { x: 6, y: 4, type: 'indestructible' },
    { x: 8, y: 7, type: 'destructible', points: 40 },
    { x: 0, y: 8, type: 'indestructible' },
    { x: 1, y: 7, type: 'destructible', points: 10 },
    { x: 3, y: 6, type: 'indestructible' },
    { x: 8, y: 0, type: 'destructible', points: 10 },
    { x: 5, y: 7, type: 'destructible', points: 10 },
    // outros blocos
];
let enemies = [
    { x: 5, y: 5 },
...
function explodeBomb(x, y) {
    ...
    setTimeout(() => {
        ...
        if (enemies.length === 0) {
            ...
            window.location.href = 'chefao.html';  // Mude para o nome do arquivo da segunda fase
        } else {
